...
public class LilyChantGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class NoteGroupElements extends AbstractParserRuleElementFinder {
		...
		private final Alternatives cSyllablesAlternatives_0_1_0 = (Alternatives)cSyllablesAssignment_0_1.eContents().get(0);
		private final RuleCall cSyllablesHYPHENTerminalRuleCall_0_1_0_0 = (RuleCall)cSyllablesAlternatives_0_1_0.eContents().get(0);
		private final RuleCall cSyllablesEXTENDERTerminalRuleCall_0_1_0_1 = (RuleCall)cSyllablesAlternatives_0_1_0.eContents().get(1);
		...
		//NoteGroup:
		//	syllables+=ID syllables+=(HYPHEN | EXTENDER)? | START_NOTE_GROUP syllables+=(ID | HYPHEN)+ END_NOTE_GROUP;
		@Override public ParserRule getRule() { return rule; }
		...
		//syllables+=(HYPHEN | EXTENDER)?
		public Assignment getSyllablesAssignment_0_1() { return cSyllablesAssignment_0_1; }
		
		//(HYPHEN | EXTENDER)
		public Alternatives getSyllablesAlternatives_0_1_0() { return cSyllablesAlternatives_0_1_0; }
		
		//HYPHEN
		public RuleCall getSyllablesHYPHENTerminalRuleCall_0_1_0_0() { return cSyllablesHYPHENTerminalRuleCall_0_1_0_0; }
		
		//EXTENDER
		public RuleCall getSyllablesEXTENDERTerminalRuleCall_0_1_0_1() { return cSyllablesEXTENDERTerminalRuleCall_0_1_0_1; }
