...
public class InternalLilyChantParser extends AbstractInternalAntlrParser {
    ...
    public final EObject ruleFormat() throws RecognitionException {
        ...
        try {
            ...
            do {
                ...
                if ( LA20_0 == RaggedBottom && getUnorderedGroupHelper().canSelect(grammarAccess.getFormatAccess().getUnorderedGroup_2(), 0) ) {
                    alt20=1;
                }
                else if ( LA20_0 == RaggedLastBottom && getUnorderedGroupHelper().canSelect(grammarAccess.getFormatAccess().getUnorderedGroup_2(), 1) ) {
                    alt20=2;
                }
    ...
    public final Enumerator ruleBarline() throws RecognitionException {
        ...
        try {
            ...
            else if ( (LA21_0==VerticalLineVerticalLine) ) {
                alt21=2;
            }
            else {
                if (state.backtracking>0) {state.failed=true; return current;}
    ...
    static final String dfa_6s = "\1\uffff\1\0\2\uffff\1\1\7\uffff}>";
